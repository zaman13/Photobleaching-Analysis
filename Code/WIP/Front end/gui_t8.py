...
def fill_output_frame():
    ...
    lbl_img.grid(row=2,column =0,  sticky = 'nw', padx= 5, pady= 10)
    spn_img.grid(row = 1, column = 0, sticky = 'nw', padx = 10)
...
def show_plot():
    ...
    # scl = min(scl, round((img.size[1]/output_frame.winfo_height()) + 0.5))
...
ifname_list = [path[0:-3] + 'after_masking.png', path[0:-3] + 'rate.png', path[0:-3] + 'normalized_rate.png', path[0:-3] + 'test_frame.png']
...
spn_img  = ttb.Spinbox(output_frame, bootstyle= 'primary',
                           values = ['Norm. Rate', 'Rate', 'Masking', 'Sample Frame'], state= 'readonly',
                           wrap = True,
                           )
# =============================================================================
# packing
