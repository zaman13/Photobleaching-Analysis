...
def main_run(path, dt, exprt_data, obj_detect_each_frame, th_factor, mean_th_fct, blur_order, block_size, obj_size_th_factor, th_type,
    ...
    N_plot_row = int(np.sqrt(frame_count))
    # =============================================================================
    ...
    print_log('* Number of frames = %i' % frame_count)
